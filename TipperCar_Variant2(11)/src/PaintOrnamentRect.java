...
public class PaintOrnamentRect implements InterDop{
    ...
    public void paint(Graphics2D g2d, Color DopColor, float _startPosX, float _startPosY) {
    	...
    	case Four:
            ...
            g2d.drawRect((int)_startPosX + 45 + 2, (int)_startPosY + 55 + 2, 10,  10);
    	...
    	case Three:
    		...
    		g2d.setPaint(Color.WHITE);
    		g2d.drawRect((int)_startPosX + 20 + 2, (int)_startPosY + 55 + 2,  10, 10);
    	...
    	case Two:
            ...
            g2d.setPaint(Color.WHITE);
            g2d.drawRect((int)_startPosX + 2, (int)_startPosY + 55 + 2, 10, 10);
            g2d.drawRect((int)_startPosX + 65 + 2, (int)_startPosY + 55 + 2, 10, 10);
    		break;
	}
